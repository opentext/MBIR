...
@NgModule({
  ...
  imports: [
    ...
    HomeTilesComponent,
    EmbeddingApiSampleComponent,
    DashboardEmbeddingSampleComponent,
    YamlSampleReportComponent,
    PlainJavascriptSampleReportComponent,
    YamlSampleDashboardComponent,
    PlainJavascriptSampleDashboardComponent,
    CrosstabDataAnalyzerComponent,
    DataProvisioningComponent,
    ReportStudioComponent,
